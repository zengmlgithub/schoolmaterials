...
<title><s:if test="#attr.goodsType!=null && #attr.goodsType.goods_type_id!=0">编辑</s:if><s:else>添加</s:else>物资类型信息</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">物资类型管理&gt;&gt;<s:if test="#attr.goodsType!=null && #attr.goodsType.goods_type_id!=0">编辑</s:if><s:else>添加</s:else>物资类型</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.goodsType!=null && #attr.goodsType.goods_type_id!=0">编辑</s:if><s:else>添加</s:else>物资类型</TD>
