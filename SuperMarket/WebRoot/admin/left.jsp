			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">物资类型管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listGoodsTypes.action" target="MainFrame">物资类型查询</a></li>
					  <li><a href="Admin_addGoodsTypeShow.action" target="MainFrame">新增物资类型</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">物资信息管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
				  ...
				  <h1 class="type"><a href="javascript:void(0)">入库物资管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listSales.action" target="MainFrame">出库物资查询</a></li>
					  <li><a href="Admin_addSaleShow.action" target="MainFrame">出库物资登记</a></li>
					  <li><a href="Admin_listSalesSum.action" target="MainFrame">出库物资汇总</a></li>
					</ul>
				  </div>
